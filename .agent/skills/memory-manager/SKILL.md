...
This is the Antigravity source of truth for `.memories/`.
...
Treat bounded file content injected at session start as a frozen snapshot.
...
- Keep plans outside memory: Antigravity planning state, `.tmp/`, or maintained `docs/`.
