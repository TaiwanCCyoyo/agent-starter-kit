...
1. **Identify the Mandate**: Determine what _must_ or _must not_ happen (e.g., "Always use Traditional Chinese for UI").
...
- **Policy over Procedure**: Rules define _what_ the result must be, not _how_ to do it.
