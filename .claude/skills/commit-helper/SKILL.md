...
3. Route durable knowledge through Claude Code's built-in memory (`.claude/rules/common/memory.md`) only when it will help future sessions; do not save commit narration or duplicate the plan.
